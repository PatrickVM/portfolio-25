    ...
    <div>
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="project-image-placeholder">Exchange Platform</div>
            <div className="p-6">
              <h5 className="text-xl font-semibold mb-2">Exchange Platform</h5>
              <p className="text-gray-600 mb-4">
                A full-featured Exchange platform with contracts, public
                profiles, realtime chat, and sleek design.
              </p>
              <div className="flex justify-between items-center">
                <div className="flex space-x-2">
                  <button
                    ...
                    onClick={() =>
                      askProjectQuestion(
                        "Tell me more about the Exchange Platform project"
                      )
                    }
                  >
                    View Details
                  ...
                  <button
                    ...
                    onClick={() =>
                      askProjectQuestion(
                        "What technologies were used in the Exchange Platform project?"
                      )
                    }
                  >
                    Technologies
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                A learning management system for Voyage Church that helps with
                inhouse training and resources.
              </p>
              <div className="flex justify-between items-center">
                <div className="flex space-x-2">
                  <button
                    ...
                    onClick={() =>
                      askProjectQuestion(
                        "Tell me more about the Learning Management System project"
                      )
                    }
                  >
                    View Details
                  ...
                  <button
                    ...
                    onClick={() =>
                      askProjectQuestion(
                        "What technologies were used in the Learning Management System project?"
                      )
                    }
                  >
                    Technologies
